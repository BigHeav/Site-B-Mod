...
{
	public class TrueForgetOrb : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Forget Orb");
		...
		public override void AI()
		{
			...
			float projSpeed = 45f; // The speed at which the projectile moves towards the target
